...
<head>
  <meta charset="UTF-8">
  <title>Verify Your Email on Spilt-N-Share</title>
            ...
            <div id="maincontent" style="max-width:620px; font-size:0;margin:0 auto;">
              ...
              <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <table border="0" cellpadding="0" cellspacing="0" style="width:100%;margin-top:5%">
                        <tbody>
                          <tr>
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td align="center" valign="top">
                                                        ...
                                                        <a href="` + verificationLink + `" target="_blank" style="background-color:#01b3e3; 
                                                        border-collapse:separate !important; border-top:10px solid #01b3e3; 
                                                        border-bottom:10px solid #01b3e3; border-right:45px solid #01b3e3; 
                                                        border-left:45px solid #01b3e3; border-radius:4px; color:#ffffff; 
                                                        display:inline-block; font-family:'Open+Sans','Open Sans',Helvetica, Arial, sans-serif; 
                                                        font-size:13px; font-weight:bold; text-align:center; text-decoration:none; 
                                                        letter-spacing:2px;">VERIFY EMAIL</a>
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
                                            ...
                                            <tr>
                                              <td style="padding-top:30px;">
                                                ...
                                                <p style="Margin:20px 0; font-size:12px; line-height:17px; word-wrap:break-word; 
                                                  ...
                                                  <a href="` + verificationLink + `" style="color:#5885ff; 
